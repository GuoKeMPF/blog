...
import { Scene, PerspectiveCamera, WebGLRenderer, PointLight, MeshPhongMaterial, Mesh, SphereGeometry, Object3D, AxesHelper, GridHelper } from "three";
...
export const SceneGraphSunEarthMoonAxesGrids: FC = () => {
  ...
  const init = () => {
    const { camera, scene, objects = [], gui } = threeObject.current!;
    ...
    objects.push(...[sunMesh, earthMesh, moonMesh]);
...
export default SceneGraphSunEarthMoonAxesGrids
