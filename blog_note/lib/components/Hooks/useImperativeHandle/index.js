...
var useFefConponent = function useFefConponent() {
  ...
  var updateInput = function updateInput() {
    ...
    if (input && input.current) {
      input.current.value = "outer set ".concat(new Date().getTime());
    }
  };
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    orientation: "left"
  }, "\u7236\u7EC4\u4EF6"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    onClick: updateInput
  }, "\u7236\u7EC4\u4EF6\u66F4\u65B0"), /*#__PURE__*/_react.default.createElement(_ref.default, {
    ref: input
  }));
};
