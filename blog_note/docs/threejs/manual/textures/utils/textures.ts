...
import mipExample from "../demo/images/mip-example.png";
const loader = new THREE.TextureLoader();

export function loadTextureAndPromise(url) {
...
export function lowResCube(scale, pixelSize = 16) {
...
export function createMip(level, numLevels, scale) {
...
export function createTextureDiagram(elem) {
