...
urlpatterns = [
    ...
    # 草稿
    re_path(r"^draft/?$", DraftViewSet.as_view(
        {"get": "list", "post": "create"}
    ), name="draft"),

    re_path(r"^draft/(?P<pk>\w+)/?$", DraftViewSet.as_view(
    ...
    re_path(r'^text/(?P<pk>\w+)/?$', TextViewSet.as_view(
        {"get": "retrieve", "put": "update",
            "patch": "partial_update", "delete": "destroy"}
    ), name="text"),
