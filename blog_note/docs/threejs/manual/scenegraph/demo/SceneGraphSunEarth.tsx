...
import { Scene, PerspectiveCamera, WebGLRenderer, PointLight, MeshPhongMaterial, Mesh, SphereGeometry } from "three";
...
export const SceneGraphSunEarth: FC = () => {
...
export default SceneGraphSunEarth
