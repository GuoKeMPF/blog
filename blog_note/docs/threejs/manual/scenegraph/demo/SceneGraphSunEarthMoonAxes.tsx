...
import { Scene, PerspectiveCamera, WebGLRenderer, PointLight, MeshPhongMaterial, Mesh, SphereGeometry, Object3D, AxesHelper } from "three";
...
export const SceneGraphSunEarthMoonAxes: FC = () => {
...
export default SceneGraphSunEarthMoonAxes
