...
const images = [
  {
    src: path.join("./mock_static/picture/img1.png"),
    width: 1200,
    height: 784,
  },
  {
    src: path.join("./mock_static/picture/img2.png"),
    width: 1004,
    height: 986,
  },
  {
    src: path.join("./mock_static/picture/img3.png"),
    width: 1000,
    height: 800,
  },
];
